...
const mainHome = ({navigation}) => {
  ...
  const culturdate1 = {
    ...
    3: '충청북도 진천군 문백면에 위치한 옛 돌다리이다. 천년이 넘은 다리로 대한민국에서 가장 오래된 돌다리이다.오늘날에도 다리의 기능을 수행하고 있어 농다리를 통해 미호천을 건널 수 있다. 1976년 12월 21일 충청북도의 유형문화재 제28호로 지정되었다. 과거에는 농교(籠橋)라고 불렀으나 2013년 현재의 명칭으로 바뀌었다.',
    4: '	역사 신라 때에 둔, 청소년의 민간 수양 단체. 문벌과 학식이 있고 외모가 단정한 사람으로 조직하였으며, 심신의 단련과 사회의 선도를 이념으로 하였다.',
